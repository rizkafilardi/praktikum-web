            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="major_code" name="major_code"
                        class="px-3 py-2 border border-zinc-300 bg-slate-50"
                        placeholder="e.g., TI01, SI02"
                        value="{{ old('major_code', $student->major_code) }}">
                    @error('major_code')
                        <div class="text-red-500">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="self-end flex gap-2">
                    <button type="submit"
                        class="bg-blue-50 border-blue-500 text-blue-500 px-3 py-2 flex items-center gap-2 cursor-pointer">
                        <i class="ph ph-floopy-disk block text-blue-500"></i>
                        <span>Update</span>
                    </button>
                </div>
            </div>
